...
export class ProductsController {
  ...
  // Trending Products CRUD
  @Post("trending")
  async createTrendingProduct(
    @Body() body: { productId: string; customImage?: string }
  ) {
    return this.productsService.createTrendingProduct(
      body.productId,
      body.customImage
    );
  }
  ...
  async updateTrendingProduct(
    @Param("id") id: string,
    @Body() body: { customImage?: string }
  ) {
    return this.productsService.updateTrendingProduct(id, body.customImage);
  }

  @Delete("trending/:id")
  async deleteTrendingProduct(@Param("id") id: string) {
    return this.productsService.deleteTrendingProduct(id);
  }
}
